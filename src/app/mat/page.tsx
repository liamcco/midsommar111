export default function Page() {
  return (
    <div className="mb-64 mt-8 text-center lg:mb-0 lg:w-full lg:max-w-5xl">
      <div className="rounded-lg border border-transparent px-5 py-4" id="mat">
        <h2 className="mb-3 text-2xl font-semibold">Mat </h2>
        <p className="text-sm opacity-50">
          När det är midsommar på Edsgatan går ingen hungrig hem. Vi kommer
          tända en grill som går varm större delen av kvällen. Det kommer finnas
          en utekyl där man kan köpa mat att grilla! Mer info kommer! Man kan
          givetvis ta med egen mat om man så behagar.
        </p>
      </div>
      ...
      >
        ...
        <p className="text-sm opacity-50">
          ...
          finnas möjlighet att köpa alkoholhaltiga drycker. Vi kommer ha en bar
          med ett brett utbud av drycker. Mer info kommer!
        </p>
      </div>
